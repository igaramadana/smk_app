<div>
    <button data-modal-target="edit-modal-{{ $kelas_id }}" data-modal-toggle="edit-modal-{{ $kelas_id }}" type="button"
    ...
    <!-- Edit Modal -->
    <div id="edit-modal-{{ $kelas_id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="edit-modal-{{ $kelas_id }}">
                ...
                <!-- Modal body -->
                <form action="{{ route('kelas.update', $kelas_id) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        <div>
                            ...
                            <input type="text" name="nama_kelas" id="nama_kelas" value="{{ $nama_kelas ?? '' }}"
                    ...
                    <div class="flex items-center justify-end pt-4 border-t border-gray-200 dark:border-gray-600">
                        <button type="button" data-modal-toggle="edit-modal-{{ $kelas_id }}"
