...
<div class="p-4 sm:ml-64">
    <div class="p-4 rounded-lg mt-14">
        ...
        ['url' => '#', 'text' => 'Data Petugas'],
       ]" />

        <div class="mt-4 bg-white rounded-lg border border-bg-gray-200 p-4">
            <div class="flex justify-between items-center">
                <h3 class="text-xl font-semibold">Data Petugas</h3>
                <button data-modal-toggle="create-petugas-modal" data-modal-target="create-petugas-modal"
...
<!-- Main modal -->
<div id="create-petugas-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="create-petugas-modal">
            ...
            <form action="{{ route('petugas.store') }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Format: JPEG, PNG,
                            JPG, GIF (Max. 2MB)</p>
                    </div>
