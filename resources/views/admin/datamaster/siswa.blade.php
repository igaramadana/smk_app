    ...
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="mt-4 bg-white rounded-lg border border-bg-gray-200 p-4">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <button data-modal-toggle="delete-siswa-modal" data-modal-target="delete-siswa-modal"
...
{{-- Delete All Modal --}}
<div id="delete-siswa-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                data-modal-hide="delete-siswa-modal">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 14 14">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Apakah Anda yakin ingin menghapus <span class="font-bold text-red-600">SEMUA DATA SISWA</span>?
                    <br><br>
                    <span class="text-sm">Aksi ini akan menghapus seluruh data siswa dan tidak dapat
                        dikembalikan!</span>
                </h3>
                <form action="{{ route('siswa.delete.all') }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                ...
                <button data-modal-hide="delete-siswa-modal" type="button"
