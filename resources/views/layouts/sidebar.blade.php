<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            {{-- Settings --}}
            <span class="ms-2 text-gray-600 text-sm">Setting</span>
            <li>
                <a href="{{route('users.edit')}}" id="menu-setting"
                    class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-100 group transition-colors duration-200 sidebar-item">
                    <svg class="shrink w-5 h-5 text-gray-500 dark:text-white" aria-hidden="true"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">User Setting</span>
                </a>
            </li>
